<template>
  <v-stepper v-model="paging">
    ...
    <v-stepper-content step="2">
      ...
      <div>
        <v-btn text @click="paging++" :loading="form.domain.onsearch"
          >Punya Sendiri</v-btn
        >
...
@Component
export default class HostingOrder extends Vue {
  ...
  getLtd(): void {
    let getData: Promise<Response> = fetch("/domain/ltd");
    getData.catch(e => {});
