    ...
    <v-container class="pt-sm-12 pt-7">
      <v-row class="pt-sm-12 pt-7">
        <v-col class="pt-sm-12 pt-7">
          ...
          <p>Kami adalah pengembang aplikasi mobile, desktop dan website dengan teknologi modern yang berbasis di Indonesia.</p>
          <p>Kami percaya bahwa setiap mitra kami akan mendapatkan pengalaman luar bisa atas hasil kerja keras kami.</p>
        </v-col>
      </v-row>
    </v-container>
      ...
      <v-container class="white--text py-10">
        <v-row dense>
          ...
          <v-col
            md="4"
            sm="12"
            class="d-flex align-start flex-column-reverse flex-wrap flex-md-column"
          >
          ...
          <!-- Col Cabang -->
          <v-col md="8" sm="12">
            <div class="d-flex flex-sm-row flex-column align-stretch">
              <v-card
              ...
              >
                ...
                >
                  ...
                  <v-card-title>{{ this_address.available ? this_address.city : "(Nantikan)" }}</v-card-title>
                </v-img>
              </v-card>
            </div>
          </v-col>
...
export default class Tentang extends Vue {
  ...
  titleTyped() {
    let title: string[] = [
      'Kami <text class="primary--text">Albasyir Group</text>',
      'Kami <text class="primary--text">Mitra Anda</text>',
      'Kami <text class="primary--text">Tim Hebat</text>'
    ];
